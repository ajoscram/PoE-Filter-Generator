...
class Arguments:
    ...
    def __init__(self, raw_args: list):
        ...
        self.input_filepath = raw_args[0]
        self.output_filepath = self.__get_output_file__(raw_args[1])
        self.handler = self.__get_handler__(raw_args[1], raw_args[2])
        self.options = self.__get_options__(raw_args)

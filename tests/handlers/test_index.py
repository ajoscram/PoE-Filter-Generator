...
from handlers.index import IndexContext, _INDEX_RULE_NAME, _SECTION_RULE_NAME, _SUBSECTION_RULE_NAME, _INDEX_HEADER, _INDEX_HINT
...
def test_handle_given_an_index_section_and_subsection_should_write_them():
    ...
    text = '\n'.join(index.handle(filter.blocks[0], IndexContext(filter, None)))
